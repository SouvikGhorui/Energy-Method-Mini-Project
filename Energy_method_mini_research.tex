...
\begin{titlepage}
  \centering
  \vspace*{2cm}
  \includegraphics[width=0.3\textwidth]{iitj_logo.jpg.png}\\[1.5cm]
...
\begin{itemize}
    ...
    \textbf{Prompt:} What is damped wave equation. Explain. \\
    \textbf{Usage:} Used to obtain a conceptual explanation of the damped wave equation, including a breakdown of its mathematical terms (acceleration, restoring force, and damping) and their physical interpretations.

    
    \medskip % Adds a little vertical space between items

    \item \textbf{AI Tool:} Gemini (Google) \\
    \textbf{Prompt:} Give me an example for applying energy method on the damped wave equation. \\
    \textbf{Usage:} Used to generate a step-by-step mathematical derivation applying the energy method. This included defining the energy functional, applying Green's First Identity, and outlining the proofs for energy dissipation and solution uniqueness.


    \medskip % Adds a little vertical space between items

    \item \textbf{AI Tool:} Gemini (Google) \\
    \textbf{Prompt:} Explain me what is reaction diffusion model in pde and how it works. \\
    \textbf{Usage:} Used to generate a conceptual overview of reaction-diffusion models in partial differential equations. This included breaking down the mathematical terms (diffusion and reaction kinetics), explaining the underlying physical mechanisms, and providing common examples such as the Fisher-KPP equation and Turing patterns.

    \item \textbf{AI Tool:} Gemini (Google) \\
    \textbf{Prompt:} How we use energy method in diffusion model. \\
    \textbf{Usage:} Used to generate a mathematical demonstration of the energy method applied to a pure diffusion model (heat equation). This included defining the $L^2$ norm as the energy functional, applying Green's First Identity to prove energy dissipation, and extending the derivation to a linear reaction-diffusion system using Gronwall's inequality to show the balance of forces.
